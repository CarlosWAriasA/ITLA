...
namespace Practica2
{
    public class EmpleadoOperativo : IEmpleado
    {
        ...
        public EmpleadoOperativo(IEmpleado empleado)
        {
        ...
        public EmpleadoOperativo(string cedula, string nombre, string departamento, int precioXHora, int horasTrabajadas)
        {
            this.Cedula = cedula;
            this.Nombre = nombre;
